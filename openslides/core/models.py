...
class Projector(RESTModelMixin, models.Model):
    ...
    header_background_color = models.CharField(max_length=7, default="#009ee3")
    header_font_color = models.CharField(max_length=7, default="#f5f5f5")
    header_h1_color = models.CharField(max_length=7, default="#009ee3")
    chyron_background_color = models.CharField(max_length=7, default="#009ee3")
